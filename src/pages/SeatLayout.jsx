...
const renderSeats = (row, count = 9) => (
  ...
  return show ?(
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      {/* Seats Layouts */}
      <div className="flex flex-1 flex-col items-center max-md:mt-16 relative">
        <BlurCircle bottom="0" left="-100px"/>
        <BlurCircle top="-100px" left="-100px"/>
        <h1 className='text-2xl font-semi-bold mb-4'>Select your Seat</h1>
      ...
      <button onClick={()=>navigate('/my-bookings')}
        className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer active:scale-95'>
          Proceed to Checkout
          <ArrowRightIcon strokeWidth={3} className="2-4 h-4"/>
        </button>
      </div>
