...
import {DateSelect, MovieCard} from '../components'
  ...
  return show ? (
    <div className='px-6 md:px-6 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        <img className='max-md:mx-auto rounded-xl h-104 max-w-70 object-cover' alt="details" 
...
<div className='flex items-center flex-wrap gap-4 mt-4'>
  ...
  < a href="#dataSelect" className='px-10 py-3 bg-primary text-sm hover:bg-primary-dull tramsition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
      ...
      <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
        <div className="flex items-center gap-4 w-max px-4">
          {show.movie.casts.slice(0,12).map((cast,index)=>
            (
            <div className='flex items-center text-center flex-col' key={index}>
