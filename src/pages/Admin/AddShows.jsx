...
const AddShows = () => {
  ...
  // Note: handleRemoveTime was not defined in your original code, you'll need to implement it if you use it.
  const handleRemoveTime = (date, timeToRemove) => {
    setDateTimeSelection((prev) => {
      const newTimes = prev[date].filter(time => time !== timeToRemove);
    ...
    <>
      ...
      <div className="mt-6">
        ...
        <div className="inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg">
          <input type="datetime-local" value={dateTimeInput} onChange={(e) => setDateTimeInput(e.target.value)} className='outline-none rounded-md text-white' />
